...
⚠️ В разделе приведен базовый перечень доступных действий.

⚠️ Подробное пошаговое описание процесса развертывания доступно в разделе **Руководство по внедрению в среде oVirt**
