...
В данном разделе описан порядок объединения брокеров в логические группы для сценариев катастрофоустойчивости.

***

### 1. Зачем нужны группы брокеров

В XRM Director группа брокеров представляет собой логическую связку из двух площадок:
...
⚠️ Без создания группы система не сможет однозначно определить, откуда должна считываться конфигурация и куда именно ее необходимо переносить.

### 2. Переход в раздел `Группы`

Для создания группы брокеров администратор открывает раздел `Группы` в интерфейсе XRM Director.

На предоставленном экране раздел отображается как `Группы`.
...
<figure><img src="/XRMD/assets/groups1.png" alt=""><figcaption></figcaption></figure>
...
<figure><img src="/XRMD/assets/groups2.png" alt=""><figcaption></figcaption></figure>
...
<figure><img src="/XRMD/assets/groups3.png" alt=""><figcaption></figcaption></figure>
