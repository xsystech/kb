...
В данном разделе описан порядок создания задания миграции, генерации плана восстановления и запуска переноса конфигурации с основной площадки на резервную.
...
<figure><img src="/XRMD/assets/jobs1.png" alt=""><figcaption></figcaption></figure>

### 2. Назначение задания миграции

Задание в XRM Director представляет собой описанный администратором сценарий переноса конфигурации.
...
<figure><img src="/XRMD/assets/jobs2.png" alt=""><figcaption></figcaption></figure>
...
<figure><img src="/XRMD/assets/jobs3.png" alt=""><figcaption></figcaption></figure>
...
⚠️ Жизненный цикл задания обычно выглядит так: создание → проверка → генерация конфигурации → запуск → анализ журналов.
...
2. отметьте его чекбоксом, если это предусмотрено интерфейсом;
...
⚠️ Ошибочно выбранное задание или неверно настроенная группа может привести к переносу конфигурации не на ту площадку.
