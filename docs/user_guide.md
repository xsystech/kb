...
**xrmd_agent_manager.py** - это многофункциональный инструмент для работы с агентами.

### Основные возможности

- ✅ **Просмотр агентов**
- ✅ **Создание и удаление сеанса с агентом**
- ✅ **Ведения диалогов с агентами**
- ✅ **Просмотр списка сеансов агента**
- ✅ **Пакетный анализатор логов** - обработка и анализ системных логов
